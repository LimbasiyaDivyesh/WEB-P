var j=Object.defineProperty,B=Object.defineProperties;var T=Object.getOwnPropertyDescriptors;var v=Object.getOwnPropertySymbols;var k=Object.prototype.hasOwnProperty,C=Object.prototype.propertyIsEnumerable;var _=(l,e,i)=>e in l?j(l,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):l[e]=i,D=(l,e)=>{for(var i in e||(e={}))k.call(e,i)&&_(l,i,e[i]);if(v)for(var i of v(e))C.call(e,i)&&_(l,i,e[i]);return l},E=(l,e)=>B(l,T(e));var g=(l,e,i)=>new Promise((t,c)=>{var n=o=>{try{r(i.next(o))}catch(y){c(y)}},m=o=>{try{r(i.throw(o))}catch(y){c(y)}},r=o=>o.done?t(o.value):Promise.resolve(o.value).then(n,m);r((i=i.apply(l,e)).next())});import{j as a,m as w}from"./uiVendor-CQWyHtf0.js";import{f as P,a as p}from"./reactVendor-BrBFq9LG.js";import{u as L,a as Y,b as M,A as b,h as I}from"./index-BJjMHafw.js";import{D as R}from"./DashboardHeader-CsovWPyS.js";import"./pdfVendor-Dbth1RHn.js";import"./reduxVendor-C8DwjTzm.js";function K(){var u;const l=P(),{t:e}=L(),{appSelector:i,dispatch:t}=Y(),{loginData:c={}}=i(s=>s.app),n=(c==null?void 0:c.admins)||[],{userData:m}=M(),{selectedAdmin:r}=i(s=>s.app),o=p.useCallback(s=>g(null,null,function*(){t(yield b({apiUrl:`auth/admin?userAdminId=${s}`,storeActionType:"SET_ADMIN_DATA",storeKey:"adminData",loader:!0}))}),[t]),y=p.useCallback(s=>{t({type:"APP_SET_SELECTED_ADMIN",payload:s,name:"selectedAdmin",meta:{type:"SET_SELECTED_ADMIN"}})},[t]),A=p.useCallback(s=>g(null,null,function*(){t(yield b({apiUrl:`deliveryBoy/access/${s}`,storeActionType:"FETCH_DELIVERY_BOY_ACCESS",storeKey:"deliveryBoyAccess",loader:!0}))}),[t]);p.useEffect(()=>{r||(y(n[0]),o(n[0]._id))},[n,r]),p.useEffect(()=>{g(null,null,function*(){yield t(yield b({apiUrl:"auth/deliveryBoy/session",loader:!1,apiSuccessCallBack:s=>{const{user:d}=s,h=E(D({},c),{role:d.role,user:d,admins:d.admins||[]});if(t({type:"APP_SET_LOGIN_DATA",payload:h,name:"loginData",meta:{type:"SET_LOGIN_DATA"}}),r!=null&&r._id){const x=((d==null?void 0:d.admins)||[]).find(S=>S._id===r._id);o(r._id),x&&y(x)}}}))})},[]);const f=()=>{(m==null?void 0:m.role)==="admin-delivery-boy"&&(t({type:"APP_SET_DELIVERY_BOY_ACCESS_FOR_ADMIN",payload:{data:{canEditList:!1,canDragDrop:!1,canViewMilkPrice:!1,viewAndEditDailySale:!1,viewDailySaleMilkPrice:!1,showPhone:!1,showName:!1,showBillColumn:!1}},name:"deliveryBoyAccess",meta:{type:"SET_DELIVERY_BOY_ACCESS_FOR_ADMIN"}}),t({type:"APP_UPDATE_DAILY_SALE_DATE",payload:I().format("YYYY-MM-DD"),name:"dailySaleDate",meta:{type:"UPDATE_DAILY_SALE_DATE"}}),l(`/deliveryBoy/register/${r.deliveryBoy._id}`))};p.useEffect(()=>{r&&A(r.deliveryBoy._id)},[r]);const N=p.useMemo(()=>[{icon:"fa-bottle-water",label:e("dashboard.deliveryBoyDashboard.dailySaleTitle"),onClick:f}],[e,r]);return a.jsxs(a.Fragment,{children:[a.jsx(R,{roleLabel:e("dashboard.header.roleDeliveryBoy"),identityName:((u=r==null?void 0:r.deliveryBoy)==null?void 0:u.name)||e("dashboard.header.roleDeliveryBoy"),identityRole:e("dashboard.header.roleDeliveryBoy"),menuItems:N}),a.jsxs("div",{className:"relative px-0 py-4 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 h-safe overflow-y-auto",children:[(n==null?void 0:n.length)>1&&a.jsx("div",{className:"px-3 sm:px-4",children:a.jsx("div",{className:`\r
        flex sm:grid\r
        sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4\r
        gap-4 sm:gap-6\r
        overflow-x-auto sm:overflow-visible\r
        no-scrollbar py-2\r
    `,children:n.map((s,d)=>{var x;const h=(r==null?void 0:r._id)===s._id;return a.jsx(w.div,{layout:!0,initial:{opacity:0,y:30,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{delay:d*.04},className:"min-w-[160px] sm:min-w-0",children:a.jsx("div",{onClick:()=>{y(s),o(s._id)},className:`
