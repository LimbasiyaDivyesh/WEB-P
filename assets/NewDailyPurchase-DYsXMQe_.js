                ...
                `,children:[e.jsx("div",{className:`
                    ...
                    `,children:[e.jsx("div",{className:"flex items-center justify-between",children:e.jsx("div",{className:`
                        ...
                        `,children:s.label})]})]},s.label)})})}),e.jsx("div",{className:"mb-4 flex justify-center",children:e.jsxs("div",{className:"relative w-full max-w-md",children:[e.jsx("input",{type:"text",placeholder:"Search by name...",value:L,onChange:s=>j(s.target.value),className:`\r
                                ...
                                text-sm\r
                            `}),e.jsx("i",{className:"fa-solid fa-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"})]})}),y&&y.length>0?e.jsxs(e.Fragment,{children:[e.jsx(Qe,{timePreference:T==null?void 0:T.toLowerCase(),entries:[...V].sort((s,x)=>{var t,k;return((t=s.registerIndex)!=null?t:-1/0)-((k=x.registerIndex)!=null?k:-1/0)}),handleUpdateCustomerMilkEntry:K,fetchRegister:$,estimate:D.estimate,showDragColumn:D.showDragColumn},"daily-register"),E.length>0&&e.jsx("div",{className:"flex justify-center mb-6",children:e.jsxs("label",{className:`\r
